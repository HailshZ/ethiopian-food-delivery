// // server.js – Full version with temporary JSON route for dish debugging
...
//     // Language switcher route (fixed deprecation warning)
...
//     // ==================== TEMPORARY JSON ROUTE TO CHECK DISHES ====================
...
//     // ==================== MENU ROUTE WITH DETAILED LOGGING ====================
//     app.get('/menu', async (req, res) => {
//       try {
//         const dishes = await Dish.find({ isAvailable: true });
//         console.log(`🍽️ Fetched ${dishes.length} dishes from database`);
//         if (dishes.length > 0) {
//           console.log('📦 First dish sample:', {
//             name: dishes[0].name,
//             nameAm: dishes[0].nameAm,
//             price: dishes[0].price
//           });
//         } else {
//           console.log('⚠️ No dishes found. Did you run /seed?');
//         }
...
//     process.exit(1);
//   });
// server.js – Full version with proper layout and error handling
require('dotenv').config();
const express = require('express');
const session = require('express-session');
const connectMongo = require('connect-mongo');
